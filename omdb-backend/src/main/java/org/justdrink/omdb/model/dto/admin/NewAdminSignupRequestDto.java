...
@NoArgsConstructor
@Builder
public class NewAdminSignupRequestDto {
    ...
    public Members toMember(PasswordEncoder passwordEncoder) {
        ...
        return Members.builder()
                ...
                .gender(gender)
                .birth(birth)
                .authority(Authority.ROLE_SADMIN)
                .build();
    }

    public MemberResponseDto toMemberResponseDto(NewAdminSignupRequestDto memberRequestDto) {
